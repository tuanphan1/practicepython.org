...
# This will just print the full text of the article to the screen. It will not make it easy 
# to read, so next exercise we will learn how to write this text to a .txt file.
...
for entries in soup.find_all(class_="content-section"):
    print(entries.text)